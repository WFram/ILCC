...
def back_project_pcd(img, pcd_arr, color_arr, r_t, i, hide_occlussion_by_marker, depth_only=True):
    # print pcd_arr
...
def vis_back_proj(ind=1, img_style="edge", pcd_style="intens", hide_occlussion_by_marker=False,
    ...
    backproj_img = back_project_pcd(img, pcd, pcd_color, r_t, ind, hide_occlussion_by_marker, depth_only=depth_only)
    ...
    if save_without_show:
        ...
        if 1:  # wait for 's' key to save and exit
